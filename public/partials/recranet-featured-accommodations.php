...
<recranet-featured-accommodations class="recranet-element" limit="<?php echo $accommodationLimit; ?>" baseUrl="<?php echo $baseUrl; ?>"></recranet-featured-accommodations>
